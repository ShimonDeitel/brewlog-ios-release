...
enum Reminders {
    private static let identifier = "brewlog.daily.reminder"
    ...
    static func schedule(hour: Int, minute: Int) {
        ...
        content.title = "Time to log your brew!"
        content.body = "Tap to record today's cup and keep dialling in your perfect brew."
